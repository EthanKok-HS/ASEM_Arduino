...
#define I2C_ERROR_ADDR_W            (I2C_ERROR_BASE + 1)
#define I2C_ERROR_ADDR_R            (I2C_ERROR_BASE + 2)
#define I2C_ERROR_DATA_SENT_ACK     (I2C_ERROR_BASE + 1)
#define I2C_ERROR_DATA_SENT_NO_ACK  (I2C_ERROR_BASE + 2)
#define I2C_ERROR_DATA_READ_ACK     (I2C_ERROR_BASE + 1)
#define I2C_ERROR_DATA_READ_NO_ACK  (I2C_ERROR_BASE + 2)
